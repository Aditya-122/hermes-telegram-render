...
# --- FIX FOR OPENROUTER GHOST CONFIG ---
# Forcefully unset any lingering OpenRouter base URLs that Hermes has cached
"$HERMES_BIN" config unset openai-api.base_url || true
"$HERMES_BIN" config unset model.base_url || true
